...
Set-Alias python310 "C:\Users\will\AppData\Local\Programs\Python\Python310\python.exe"
Set-Alias python37 "C:\Users\will\AppData\Local\Programs\Python\Python37\python.exe"
Set-Alias upip Upgrade-Pip
Set-Alias Run-Roop "cd P:\@ai\roop && venv && python run.py --execution-provider cuda"
Set-Alias tws Start-TrainingWebServer
